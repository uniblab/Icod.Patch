...
echo.
echo === Clean ===
dotnet clean Icod.Patch.sln -c Debug
exit /b %errorlevel%

:restore
echo.
echo === Restore ===
dotnet restore Icod.Patch.sln
exit /b %errorlevel%

:build
echo.
echo === Build ===
dotnet build Icod.Patch.sln -c Debug --no-restore
exit /b %errorlevel%

:test
echo.
echo === Test ===
dotnet test Icod.Patch.sln -c Debug --no-build
exit /b %errorlevel%
