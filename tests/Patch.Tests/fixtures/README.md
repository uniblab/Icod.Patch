...
- `icod-diffutils/` contains captured unified, context, normal, and ed output shaped as produced by Icod Diffutils. P12 applies all four through the public command. Production and test projects have no project or runtime dependency on Diffutils.
...
The authoritative upstream archive and checksum are recorded in `upstream/GNU-patch-2.8.md`.
